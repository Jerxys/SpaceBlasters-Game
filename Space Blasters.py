...
menu_image = pygame.image.load("mainmenu.jpg").convert()
...
while not done and display_instructions:
    ...
    if instruction_page == 1:
        ...
        text = font.render("Welcome to Shootem Up", True, WHITE)
        screen.blit(text, [10, 10])
 
        text = font.render("Click To Proceed", True, WHITE)
        screen.blit(text, [10, 40])
 
    if instruction_page == 2:
        # Draw instructions page 2
        text = font.render("Move your ship with your mouse", True, WHITE)
        screen.blit(text, [10, 10])
 
        text = font.render("Click to shoot ", True, WHITE)
        screen.blit(text, [10, 40])
       
        text = font.render("Kill 25 enemies and proceed to the next ", True, WHITE)
        screen.blit(text, [10, 70])      
     
        text = font.render("and kill 55 to win the game ", True, WHITE)
        screen.blit(text, [10, 100])               
         
    
    if instruction_page == 3:
            # Draw instructions page 3
        text = font.render("Place your mouse at the bottom by ", True, WHITE)
        screen.blit(text, [10, 10])
     
        text = font.render(" moving it outside the screen", True, WHITE)
        screen.blit(text, [10, 40])   
        
        text = font.render("and moving it to the bottom and click ", True, WHITE)
        screen.blit(text, [10, 70]) 
